...
public class Consume_WebClient {
          //created instance of web client  describe my base url that i want to consume
...
//    @GetMapping("/mono-movie-cinema/{id}")//without response entity
...
//    ---------------------------WEBCLIENT---------------------------
    ...
    public Flux<MovieCinemaDTO> readWithWebClient(){
        ...
        return webClient // with those instance start to build my webClient
                .get()
                .uri("/flux-movie-cinemas")// base uri + end point
