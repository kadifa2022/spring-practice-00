...
public class QueryDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println(accountRepository.fetchAdminAccount());
        ...
        System.out.println(ticketRepository.fetchAllTicketsByUserAccount(2L));
        ...
        System.out.println(userRepository.fetchAllUser());
    }
}
