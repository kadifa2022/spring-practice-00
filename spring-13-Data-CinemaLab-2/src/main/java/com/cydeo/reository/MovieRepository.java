...
public interface MovieRepository extends JpaRepository<Movie, Long > {
    ...
    //Write a derived query to list all movies where duration exists in specific list of duration
    ...
    //Write a native query that return the list of movies in a specific range prices
    ...
    List<Movie> retrieveByDurationInRange(@Param("duration") List<Integer> durations);  // in statement with List of integers
