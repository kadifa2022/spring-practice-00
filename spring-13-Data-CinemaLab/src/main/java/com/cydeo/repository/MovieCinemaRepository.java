...
import com.cydeo.entity_model.MovieCinema;
...
public interface MovieCinemaRepository extends JpaRepository<MovieCinema, Long> {
    ...
    Optional<MovieCinema> findById(Long id); // already exist in CRUD Repository
    ...
    //Write a derived query to list all movie cinemas with higher than specific date
    ...
    //Write a derived query to list all movie cinemas in specific location name
