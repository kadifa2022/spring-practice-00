...
import com.cydeo.entity_model.Ticket;
...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    //Write a derived query to count how many ticket are sold for a specific movie
    ...
    @Query(value = "SELECT * FROM ticket t JOIN user_account ua ON t.user_ucount_id = ua.id" +
    ...
    @Query(value = "SELECT * FROM ticket t JOIN user_account ON t.user_account_id = ua.id " +
